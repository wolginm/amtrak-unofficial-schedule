    ...
    stages {
                ...
                stage('Build Docker Image') {
                    ...
                    steps {
                        ...
                        docker build \
                            ...
                            -t $DOCKER_USER/amtrak-unofficial-schedule:latest .
                        '''
                    }
                }
            }
        ...
        stage('Deploy Docker Image to Dockerhub') {
            ...
            steps {
                ...
                docker push $DOCKER_USER/amtrak-unofficial-schedule:latest
                docker image tag $DOCKER_USER/amtrak-unofficial-schedule:latest $JAR_NAME
